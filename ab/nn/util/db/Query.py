...
def _anchor_band_db(
    *,
    ...
    """
    Fast anchor-band retrieval with prompt-design-compatible output.

    Requires:
      - nn_minhash(nn, hashvalues, ...)
      - prepared temp candidate table from _prepare_anchor_candidates()
